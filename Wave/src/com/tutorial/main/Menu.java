...
public class Menu extends MouseAdapter {
	...
	public void mousePressed(MouseEvent e) {
		...
		//quit button
		if(mouseOver(my, my, 210, 350, 200, 64)){
			System.exit(1);
	...
	public void render(Graphics g) {
		if(game.gameState == STATE.Menu) {
			...
			g.setFont(fnt3);
			g.drawString("Used WASD keys to move player and dodge enemies" , 60, 200);
			g.setFont(fnt2);
			g.drawRect(210, 350, 200, 64);
		...
		g.setFont(fnt);
		g.setColor(Color.white);
		g.drawString("Winner! ", 205, 105);
		g.setFont(fnt3);
		g.drawString("You won with a score of: " + hud.getScore() , 175 , 220);
		g.setFont(fnt2);
		g.drawRect(210, 350, 200, 64);
